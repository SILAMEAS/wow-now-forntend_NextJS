...
export const ButtonSubmit = ({btnName, disable}: IButtonSubmit) => {
    return <div className="mt-4 flex items-center justify-end gap-x-2">
        <button
            // disabled={disable}
            className="bg-white text-gray-800 font-bold rounded border-b-2 border-green-500 disabled:border-red-500 hover:border-green-600 hover:bg-green-500 disabled:hover:bg-red-500  hover:text-white shadow-md py-2 px-6 inline-flex items-center">
